...
func expandComputeInstance(project string, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (*compute.Instance, error) {
	...
	return &compute.Instance{
		...
		Tags:                       resourceInstanceTagsStruct(d),
		Params:                     params,
		...
		ConfidentialInstanceConfig: expandConfidentialInstanceConfigStruct(d),
		AdvancedMachineFeatures:    expandAdvancedMachineFeaturesStruct(d),
		ShieldedInstanceConfig:     expandShieldedVmConfigsStruct(d),
		DisplayDevice:              expandDisplayDeviceStruct(d),
